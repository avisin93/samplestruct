...
export class CurrenciesService {
  ...
  */
  getCurrencyConversionsData(projectId) {
    return this._http.get(URL_PATHS.projectSettingUrl + '/' + URL_PATHS.currencyConversionsUrl + '/' + projectId);
  }
  /**
  * this method is used to get valid user accounts data offline(json)
  */
  updataData(projectId, projectData) {
    return this._http.put(URL_PATHS.projectSettingUrl + '/' + URL_PATHS.currencyConversionsUrl + '/' + projectId, projectData);
  }
