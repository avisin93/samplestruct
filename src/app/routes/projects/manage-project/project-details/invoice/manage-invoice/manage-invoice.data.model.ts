  ...
  static setFormData(invoiceDetails: any, documents, poData) {
    ...
    if (invoiceDetails) {
      ...
      invoiceFormData = {
        ...
        'taxId': payeeData.taxId ? payeeData.taxId : '',
      ...
      if (poData.purchaseOrderFor !== PURCHASE_ORDER_TYPE.talent) {
        ...
        invoiceFormData['percentISRWithholding'] = invoiceDetails.invoiceISRWitholding ? parseFloat(invoiceDetails.invoiceISRWitholding) : '';
        ...
        invoiceFormData['percentMarkup'] = invoiceDetails.percentMarkup ? parseFloat(invoiceDetails.percentMarkup) : '';
  ...
  static getFormData(invoiceDetails: any, purchaseOrderFor) {
    ...
    if (invoiceDetails) {
      ...
      if (purchaseOrderFor !== PURCHASE_ORDER_TYPE.talent) {
        ...
        invoiceFormData['invoiceISRWitholding'] = invoiceDetails.percentISRWithholding ? parseFloat(invoiceDetails.percentISRWithholding) : '';
        ...
        invoiceFormData['percentMarkup'] = (invoiceDetails.percentMarkup || invoiceDetails.percentMarkup == 0) ? parseFloat(invoiceDetails.percentMarkup) : '';
