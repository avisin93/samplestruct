...
import { AddEditClientVendorProductComponent } from './add-edit-product/add-edit-product.component';
import { HttpClient } from '@angular/common/http';

@Component({
  selector: 'app-client-vendor-products',
  templateUrl: './products.component.html',
  styleUrls: ['./products.component.scss']
})

export class ClientVendorProductsComponent implements OnInit {
  ...
  getAllPricing () {
        // fake api
    this.http.get('http://www.json-generator.com/api/json/get/cfkWTBCQlK?indent=2')
            .subscribe((data: any) => {
              this.records = data;
  ...
  addProduct () {
    let addProductDialogRef = this.dialog.open(AddEditClientVendorProductComponent, this.dialogOptions);
    addProductDialogRef.componentInstance.heading = 'Add Product';
    addProductDialogRef.componentInstance.saveBtnTitle = 'Add';
    addProductDialogRef.componentInstance.mode = 'add';
